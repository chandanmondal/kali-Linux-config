...
# system details
echo -e "\n\n${YELLOW}[i]${RESET} System Details"
echo -e "[i] Checking User" > troubleshoot.log
hostnamectl | tee -a troubleshoot.log
grep VERSION /etc/os-release | tee -a troubleshoot.log
cat /etc/apt/sources.list | tee -a troubleshoot.log
apt-cache policy initramfs-tools-bin initramfs-tools | tee -a troubleshoot.log
lsof /var/lib/dpkg/lock | tee -a troubleshoot.log
